...
Invoke-WebRequest https://git.system.local/rest/api/latest/projects/~U150239/repos/windows-setup/archive?format=zip -OutFile $global:INSTALLATION_PATH/windows-setup.zip
